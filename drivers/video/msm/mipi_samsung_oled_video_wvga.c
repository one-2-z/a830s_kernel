...
#define MIPI_CLOCK_300MBPS

static struct msm_panel_info pinfo;

#ifdef MIPI_CLOCK_300MBPS
...
static int __init mipi_video_samsung_oled_wvga_pt_init(void)
{
...
#else
	pinfo.lcdc.h_back_porch = 64;//32;
	pinfo.lcdc.h_front_porch = 20;//64;
	pinfo.lcdc.h_pulse_width = 16;//16;
	...
	ret = mipi_samsung_oled_device_register(&pinfo, MIPI_DSI_PRIM,
