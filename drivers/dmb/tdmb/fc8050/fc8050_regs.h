...
//#define FEATURE_FIT_FRAME_SIZE
#define FC8050_USE_I2C
#endif /* FEATURE_DMB_I2C_CMD */

#if defined(FEATURE_DMB_I2C_CMD) && defined(FEATURE_DMB_I2C_HW)
#define FC8050_USE_QUP_I2C
#endif

#ifdef FEATURE_DMB_SPI_IF
#define FC8050_USE_SPI
